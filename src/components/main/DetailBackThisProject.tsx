...
const DetailBackThisProject: React.FC<DetailBackThisProjectProps> = ({ backThisProjectClick }) => {
  ...
  return (
    <>
      ...
      <button className={styles.button} onClick={backThisProjectClick}>✖️</button>
        {
              ...
              <div className={styles.details__projects__and__enter__your__pledge}>
                                ...
                                {/* when the bottomToggle's id is the same as the one being clicked, show "Enter your pledge div" */}
                {
                  ...
                  <>
                    ...
                    {buttonToggelePledge === index && <ThankYou resetPerkSelection={resetPledgeSelection} backThisProjectClick={backThisProjectClick} />}
                  </>
                :
                  <></>
                }
